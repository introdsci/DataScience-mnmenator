...
The third deliverable documents changes that were made to the first two deliverables, tests an additional predictor for the model, and discusses possible routes for operationalizing the findings.
