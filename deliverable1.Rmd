...
This looks much better. Now that all of our seeds are numeric, let's make sure they're encoded as such so we can properly compare them.
...
Next we should address the NA problem. We have no way of comparing nonseeded players directly to each other, so for the sake of this analysis, we will assign them the same number that our non-numeric seeds were given.
