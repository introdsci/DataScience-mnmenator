...
The distinction rest of the non-numeric seeds are also not relevant to our analysis, and can all be treated as equivalent and less than any numeric seed. For now, we'll give them a numeric value that is greater than any numeric seed, to indicate that they are expected to lose to normal seeds.
